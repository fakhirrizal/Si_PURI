...
<div class="row">
	...
	<table class="table table-bordered table-striped" id="myTable">
		<thead>
			...
			<th style="text-align: center" width="16%">Asal</th>
			<th style="text-align: center" width="25%">Tipe Author</th>
		...
		<tbody>
			...
			<tr class="gradeX">
				...
				<td><?php echo $nama; ?></td>
				<td style="text-align: center"><?php echo $this->Main_model->convert_tanggal($tanggal_lahir); ?></td>
				<td><?php echo $asal; ?></td>
				<td><?php
				if($tipe=='p'){
					echo 'Personal Name';
