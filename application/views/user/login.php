...
<div style="text-align: center;"><H1>ADMIN LOGIN</H1>
</div>
<?php
...
<ul class="ul-list">
<li><input type="email" name="email" class="input" required placeholder="Username (your email address)" maxlength="50" value="<?php echo set_value('email'); ?>"/><span class="icon"><i class="fa fa-user"></i></span></li>
<li><input type="password" name="password" class="input" required placeholder="Password" minlength="5" maxlength="50" value="<?php echo set_value('password'); ?>"/><span class="icon"><i class="fa fa-lock"></i></span></li>
