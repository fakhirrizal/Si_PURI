				...
				<div class='container'>
					<div class='lib-form'>
						...
						<form method='POST' action="<?php echo site_url('Pengguna/masuk'); ?>">
							...
							<label>Email</label>
							<input required class='u-full-width' name="email" autofocus type='email' placeholder='username@your_domain'/>

							<label>Kata Sandi</label>
							<input required class='u-full-width' name="password" type='password' placeholder='********'/>
							...
							<div class='row'>
								...
								<div class='eight columns'>
									<div class='link-reset'>
										<a href='#'>Atur ulang kata sandi</a>
									</div>
								</div>
							</div>
					...
					<div class='link-form'>
						Tidak punya akun? <a href='<?php echo site_url('Pengguna/guest'); ?>'>Masuk sebagai tamu</a>
					</div>
				</div>
			</div>
			<footer>
