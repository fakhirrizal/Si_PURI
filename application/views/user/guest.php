...
<html lang="en">
	<head>
		...
		<title>Si-PURI | Masuk sebagai tamu</title>
			...
			<div id='content'>
				<div class='container'>
					<div class='lib-form'>
						...
						<form method='POST' action="<?php echo site_url('pengguna_perpustakaan'); ?>">
					...
					<div class='link-form'>
						Sudah punya akun? <a href="<?php echo site_url('Perpustakaan'); ?>">Masuk disini</a>
					</div>
				</div>
			</div>
			<footer>
