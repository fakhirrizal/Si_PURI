    ...
    <!-- gauge.js -->
    <script src="<?=base_url('assets4/vendors/gauge.js/dist/gauge.min.js');?>"></script>
    <!-- bootstrap-progressbar -->
    <script src="<?=base_url('assets4/vendors/bootstrap-progressbar/bootstrap-progressbar.min.js');?>"></script>
    <!-- iCheck -->
    <script src="<?=base_url('assets4/vendors/iCheck/icheck.min.js');?>"></script>
    <!-- Skycons -->
    <script src="<?=base_url('assets4/vendors/skycons/skycons.js');?>"></script>
    <!-- Flot -->
    <script src="<?=base_url('assets4/vendors/Flot/jquery.flot.js');?>"></script>
    <script src="<?=base_url('assets4/vendors/Flot/jquery.flot.pie.js');?>"></script>
    <script src="<?=base_url('assets4/vendors/Flot/jquery.flot.time.js');?>"></script>
    <script src="<?=base_url('assets4/vendors/Flot/jquery.flot.stack.js');?>"></script>
    <script src="<?=base_url('assets4/vendors/Flot/jquery.flot.resize.js');?>"></script>
    <!-- Flot plugins -->
    <script src="<?=base_url('assets4/vendors/flot.orderbars/js/jquery.flot.orderBars.js');?>"></script>
    <script src="<?=base_url('assets4/vendors/flot-spline/js/jquery.flot.spline.min.js');?>"></script>
    <script src="<?=base_url('assets4/vendors/flot.curvedlines/curvedLines.js');?>"></script>
    <!-- DateJS -->
    <script src="<?=base_url('assets4/vendors/DateJS/build/date.js');?>"></script>
    <!-- JQVMap -->
    <script src="<?=base_url('assets4/vendors/jqvmap/dist/jquery.vmap.js');?>"></script>
    <script src="<?=base_url('assets4/vendors/jqvmap/dist/maps/jquery.vmap.world.js');?>"></script>
    <script src="<?=base_url('assets4/vendors/jqvmap/examples/js/jquery.vmap.sampledata.js');?>"></script>
    <!-- bootstrap-daterangepicker -->
    <script src="<?=base_url('assets4/vendors/moment/min/moment.min.js');?>"></script>
    <script src="<?=base_url('assets4/vendors/bootstrap-daterangepicker/daterangepicker.js');?>"></script>
    <!-- Datatables -->
