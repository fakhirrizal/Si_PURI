										...
										<div>
											<ul class="list-unstyled spaced">
												...
												<li>
													...
													<a data-toggle="modal" data-target="#modal_kirim_email" title="kirim email pemberitahuan">
									...
									<table class="table table-striped table-bordered">
										...
										<tbody>
											...
											<tr style="background-color: red;">
												...
												<td><a href="<?php echo site_url('Peminjaman/kembalikan_satu/'.$d1->id)?>" title="Kembalikan satu buku"><i class="fa fa-check"></i></a>
													|
													<a href="<?php echo site_url('Peminjaman/kembalikan_semua2/'.$d1->id)?>" title="Kembalikan semua buku"><i class="fa fa-check-square-o"></i></a>
												</td>
											</tr>
											<?php }
												else{
											...
											<tr>
												...
												<?php
													...
													elseif($d2->kurang==1){
												?>
												<td><a href="<?php echo site_url('Peminjaman/kembalikan_satu/'.$d2->id)?>" title="Kembalikan satu buku"><i class="fa fa-check"></i></a>
													|
													<a href="<?php echo site_url('Peminjaman/kembalikan_satu/'.$d2->id)?>" title="Kembalikan semua buku"><i class="fa fa-check-square-o"></i></a>
												</td>
												<?php
													}
													else{
												...
												<td><a href="<?php echo site_url('Peminjaman/kembalikan_satu/'.$d2->id)?>" title="Kembalikan satu buku"><i class="fa fa-check"></i></a>
													|
													<a href="<?php echo site_url('Peminjaman/kembalikan_semua3/'.$d2->id)?>" title="Kembalikan semua buku"><i class="fa fa-check-square-o"></i></a>
												</td>
												<?php
													}
												?>
	...
	<div class="modal fade" id="modal_kirim_email" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
		<div class="modal-dialog" >
			<div class="modal-content">
				<div class="modal-body"><button type="button" class="bootbox-close-button close" data-dismiss="modal" aria-hidden="true" style="margin-top: -10px;">×</button>
					<div class="bootbox-body">
						...
						?>
							<form class="form-horizontal" role="form" action="<?php echo site_url('perpustakaan/kirim_email_pemberitahuan'); ?>" method="post" enctype='multipart/form-data'>
								<!-- #section:elements.form -->
								<?php
								foreach ($data_user as $key => $value) {
									echo '<input name="id_peminjaman" type="hidden" value="'.$value->id_peminjaman.'" />';
									echo '<input name="email" type="hidden" value="'.$value->email.'" />';
									echo '<input name="nama" type="hidden" value="'.$value->nama.'" />';
								}
								?>
								<h4>Isi Pesan </h4>
