                                ...
                                <div class="portlet light profile-sidebar-portlet ">
                                    ...
                                    <?php
                                        if(empty($value->picture_url)){
                                            ...
                                            echo '<img src="'.base_url('assets2/uploads/foto_profil/').$value->picture_url.'" class="img-responsive" alt="">';
                                        }
                                    ?>
                                    ...
                                    <div class="profile-usermenu">
                                        <ul class="nav">
                                            ...
                                            <li>
                                                <a href="<?php echo site_url('Risalah/ganti_sandi'); ?>">
                                                    <i class="icon-lock"></i> Pengaturan Kata Sandi </a>
                                            </li>
                                            <li>
                                                <a href="<?php echo site_url('Risalah/ganti_email'); ?>">
                                            ...
                                            <div class="portlet-body">
                                                <div class="tab-content">
                                                    ...
                                                    <div class="tab-pane active" id="tab_1_1">
                                                        <form role="form" action="<?php echo site_url('Risalah/ubah_profil'); ?>" method="post">
                                                    ...
                                                    <div class="tab-pane" id="tab_1_2">
                                                        ...
                                                        <form action="<?php echo site_url('Risalah/ubah_foto'); ?>" role="form" enctype='multipart/form-data' method="post">
                                                            <div class="form-group">
