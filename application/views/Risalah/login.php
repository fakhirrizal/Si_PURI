    ...
    <body class=" login">
        ...
        <div class="logo">
            ...
            <!--     <img src="<?=base_url('assets2/pages/img/logo-big.png');?>" alt="" /> </a> -->
                <img src="<?=base_url('assets3/images/logo_risalah.png');?>" height="47" width="134" alt='Pustaka'/>
            </a>
        </div>
        <!-- END LOGO -->
        <!-- BEGIN LOGIN -->
        <div class="content">
            ...
            <form class="login-form" action="<?php echo site_url('Risalah/masuk'); ?>" method="post">
                ...
                <div class="form-group">
                    ...
                    <div class="input-icon">
                        ...
                        <input class="form-control placeholder-no-fix" type="email" autocomplete="off" placeholder="Email" name="email" maxlength="50" /> </div>
                </div>
                <div class="form-group">
                    <label class="control-label visible-ie8 visible-ie9">Password</label>
                    <div class="input-icon">
                        <i class="fa fa-lock"></i>
                        <input class="form-control placeholder-no-fix" type="password" autocomplete="off" placeholder="Password" name="password" maxlength="20" /> </div>
                </div>
            ...
            <form class="forget-form" action="<?php echo site_url('Risalah/admin'); ?>" method="post">
                ...
                <div class="form-group">
                    <div class="input-icon">
                        <i class="fa fa-envelope"></i>
                        <input class="form-control placeholder-no-fix" type="text" autocomplete="off" placeholder="Email" name="email" maxlength="50" /> </div>
                </div>
                <div class="form-actions">
        ...
        <!-- END LOGIN -->
        <!-- BEGIN COPYRIGHT -->
        <div class="copyright"> 2014 &copy; Metronic - Si PURI. </div>
        <!-- END COPYRIGHT -->
        <!--[if lt IE 9]>
