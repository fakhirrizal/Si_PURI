...
<head>
	...
	<link href="http://fonts.googleapis.com/css?family=Open+Sans:400,300,600,700&subset=all" rel="stylesheet"
		type="text/css" />
	<link href="<?=base_url('assets2/global/plugins/font-awesome/css/font-awesome.min.css');?>" rel="stylesheet"
		type="text/css" />
	<link href="<?=base_url('assets2/global/plugins/simple-line-icons/simple-line-icons.min.css');?>" rel="stylesheet"
		type="text/css" />
	<link href="<?=base_url('assets2/global/plugins/bootstrap/css/bootstrap.min.css');?>" rel="stylesheet"
		type="text/css" />
	<link href="<?=base_url('assets2/global/plugins/bootstrap-switch/css/bootstrap-switch.min.css');?>" rel="stylesheet"
		type="text/css" />
	<!-- END GLOBAL MANDATORY STYLES -->
	<!-- BEGIN PAGE LEVEL PLUGINS -->
	<link href="<?=base_url('assets2/global/plugins/cubeportfolio/css/cubeportfolio.css');?>" rel="stylesheet"
		id="style_components" type="text/css" />
	<!-- END PAGE LEVEL PLUGINS -->
	<!-- BEGIN THEME GLOBAL STYLES -->
	<link href="<?=base_url('assets2/global/css/components.min.css');?>" rel="stylesheet" id="style_components"
		type="text/css" />
	...
	<link href="<?=base_url('assets2/layouts/layout/css/themes/darkblue.min.css');?>" rel="stylesheet" type="text/css"
		id="style_color" />
...
<body class="page-header-fixed page-sidebar-closed-hide-logo page-content-white">
					...
					<li class="dropdown dropdown-user">
						<a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown"
							...
							<span class="username username-hide-on-mobile">
								<?php echo $this->session->userdata('uname'); ?> </span>
			...
			<div class="page-content">
				...
				<div class="portfolio-content portfolio-2">
					<div id="js-filters-mosaic" class="cbp-l-filters-button">
						<div data-filter=".print"
							class="cbp-filter-item btn green btn-outline uppercase cbp-filter-item-active"> Foto
							Kegiatan
					...
					<div id="js-grid-mosaic" class="cbp cbp-l-grid-mosaic">
						...
						<div class="cbp-item print">
							...
							<a href="<?=base_url()?>assets2/uploads/foto_kegiatan/<?=$value->nama_file;?>"
								class="cbp-caption cbp-lightbox">
								<div class="cbp-caption-defaultWrap">
									<img src="<?=base_url()?>assets2/uploads/foto_kegiatan/<?=$value->nama_file;?>"
										alt="" style="width: 331px; left: 0px; top: 0px;"> </div>
					...
					<div style="text-align: center;">
						<br>
						<iframe src="<?=base_url()?>assets2/uploads/document/<?=$value->nama_file;?>" height="600"
							width="1075"></iframe>
					</div>
					<?php } ?>
				</div>
							...
							<div class="blog-single-content bordered blog-container">
								...
								<div class="blog-single-head">
									<h1 class="blog-single-head-title">
										<?= $value->nama_acara." (".$value->nomor_risalah.")"; ?></h1>
									<div class="blog-single-head-date">
										<i class="icon-calendar font-blue"></i>
										<a
											href="javascript:;"><?= date('d-m-Y', strtotime($value->tanggal_acara)); ?></a>
									</div>
								</div>
								...
								<div class="blog-single-foot">
									<ul class="blog-post-tags">
										<li class="uppercase">
											<a href="#">Tanggal input :
												<?= date('d-m-Y', strtotime($waktu[0]))." jam ".$waktu[1]; ?></a>
										</li>
										<!-- <li class="uppercase">
							...
							<div class="blog-single-sidebar bordered blog-container">
								...
								<div class="blog-single-sidebar-recent">
									<ul>
										<?php
                                            ...
                                            ?>
										<li>
											<a data-toggle="modal" data-target="#edit-foto-<?= $value->id; ?>">Foto
												<?= $no++; ?></a>
										</li>
										<?php } ?>
										<li>
								...
								<div class="blog-single-sidebar-tags">
									...
									<ul class="blog-post-tags">
										...
										<li class="uppercase">
											<a
												href="<?php echo site_url('Risalah/detail/'.$value->id_risalah)?>"><?= $value->nomor_risalah; ?></a>
										</li>
										<?php } ?>
									</ul>
								</div>
							...
							<div class="modal-body">
								<div class="box box-primary">
									...
									<form class="form-horizontal" method="post"
										action="<?php echo site_url('Risalah/ubah_audio'); ?>"
						...
						<div class="modal-content">
							...
							<div class="modal-body">
								<div class="box box-primary">
									...
									<form class="form-horizontal" method="post"
										action="<?php echo site_url('Risalah/ubah_dokumen'); ?>"
										enctype='multipart/form-data'>
										...
										<div class="box-body">
											...
											<div class="input-group">
												...
												<input name="dokumen" type="file" accept="application/pdf"
													class="form-control">
											</div>
											<p><strong>Catatan:</strong></p>
											<p>File maksimum: 8Mb.</p>
					...
					<div class="modal-dialog" role="document">
						<div class="modal-content">
							...
							<div class="modal-body">
								<div class="box box-primary">
									<form class="form-horizontal" method="post"
										action="<?php echo site_url('Risalah/tambah_foto_kegiatan'); ?>"
										enctype='multipart/form-data'>
										<div class="box-body">
											<input name="id_risalah" type="hidden" value="<?php echo $id_risalah;?>">
											<div class="input-group">
				...
				<?php
                        foreach ($gambar as $key => $value) {
                    ?>
				<div class="modal fade" id="edit-foto-<?= $value->id; ?>" tabindex="-1" role="dialog"
						...
						<div class="modal-content">
							...
							<div class="modal-body">
								<div class="box box-primary">
									...
									<form class="form-horizontal" method="post"
										action="<?php echo site_url('Risalah/ubah_foto_kegiatan'); ?>"
										enctype='multipart/form-data'>
										<div style='text-align: center'>
											<img src="<?=base_url()?>assets2/uploads/foto_kegiatan/<?=$value->nama_file;?>"
												alt="" style="width: 331px;">
										</div>
										<div class="box-body">
										...
										<div class="box-footer">
											...
											<a onclick="return confirm('Anda yakin?')"
												href='<?= site_url('Risalah/hapus_foto_kegiatan/'.$id_risalah.'/'.$value->id) ?>'
												class="btn btn-danger">Hapus Foto Kegiatan <i
	...
	<div class="page-footer">
		<div class="page-footer-inner"> &copy; Si PURI.
		</div>
	...
	<script src="<?=base_url('assets2/global/plugins/bootstrap/js/bootstrap.min.js');?>" type="text/javascript">
	</script>
	<script src="<?=base_url('assets2/global/plugins/js.cookie.min.js');?>" type="text/javascript"></script>
	<script src="<?=base_url('assets2/global/plugins/bootstrap-hover-dropdown/bootstrap-hover-dropdown.min.js');?>"
		type="text/javascript"></script>
	<script src="<?=base_url('assets2/global/plugins/jquery-slimscroll/jquery.slimscroll.min.js');?>"
		type="text/javascript"></script>
	<script src="<?=base_url('assets2/global/plugins/jquery.blockui.min.js');?>" type="text/javascript"></script>
	<script src="<?=base_url('assets2/global/plugins/bootstrap-switch/js/bootstrap-switch.min.js');?>"
		type="text/javascript"></script>
	<!-- END CORE PLUGINS -->
	<!-- BEGIN PAGE LEVEL PLUGINS -->
	<script src="<?=base_url('assets2/global/plugins/cubeportfolio/js/jquery.cubeportfolio.min.js');?>"
		type="text/javascript"></script>
	<!-- END PAGE LEVEL PLUGINS -->
